// lib/parking.ts
import { Zone, ParkingRecommendation, ParkingAuditLog, ZoneStatus } from '@/types';
...
const recommendations: ParkingRecommendation[] = [
    { id: "R-001", zoneId: "Z-A", zoneName: "Zone Alpha", action: "Increase pricing by KES 70", reason: "Zone at 95% capacity with rising demand", confidence: 92, impact: "Expected 18% congestion reduction in 20 mins", type: "price_increase", timestamp: new Date().toISOString(), status: "pending" },
...
const auditLogs: ParkingAuditLog[] = [
