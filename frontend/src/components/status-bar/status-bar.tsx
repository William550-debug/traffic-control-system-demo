...
function UserChip() {
    ...
    // Guard: user is read from client-side storage so it is always null on the
    // server. Without this, React hydrates a mismatched tree — the server skips
    // UserChip and renders LangToggle's <button>, but the client finds a user
    // and renders UserChip's <div> in its place.
