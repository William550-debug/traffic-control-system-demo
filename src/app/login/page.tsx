...
// ── Mock PINs (in real system these come from the server) ──
...
export default function LoginPage() {
    ...
    useEffect(() => {
        setMounted(true);
        if (user) router.replace('/operator');
    }, [user, router]);
    ...
    return (
        ...
        `,
            ...
            <div style={{
                ...
                maxWidth:     480,
                padding:      '0 24px',
                animation:    'slide-in-up 400ms ease both',
            }}>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div style={{
                                            ...
                                            height:         40,
                                            borderRadius:   '50%',
                                            background:     `${agencyColor}20`,
                                            border:         `1px solid ${agencyColor}40`,
                                            display:        'flex',
                                            alignItems:     'center',
                                            justifyContent: 'center',
                                            flexShrink:     0,
                        ...
                        <div style={{
                            ...
                            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
                                <div style={{
                                    ...
                                    fontSize:       '0.65rem',
                                    fontWeight:     700,
                                    color:          AGENCY_COLORS[selected.agency],
                                }}>
                                    {selected.initials}
                                </div>
                                <div>
